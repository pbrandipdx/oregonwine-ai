    ...
    <div className="pnz">
      ...
      <style>{`
        ...
        @media (max-width: 700px) {
          ...
          .pnz-swatch { width: 38px; height: 54px; }
          .pnz-script { font-size: clamp(3.5rem, 17vw, 6rem); }
          .pnz-line { font-size: 0.85rem; letter-spacing: 0.35em; }
          .pnz-small { font-size: 0.65rem; letter-spacing: 0.22em; }
          .pnz-tagline { font-size: 1.35rem; margin-top: 1.5rem; }
          .pnz-chevron { font-size: 1.6rem; margin-top: 1rem; }
          .pnz-hero { height: clamp(500px, 76vh, 680px); }
          .pnz-welcome { padding: 2.5rem 1.25rem 3rem; }
          .pnz-welcome p { font-size: 0.95rem; line-height: 1.65; }
          .pnz-popover {
            top: auto;
            right: 0;
            bottom: 0;
